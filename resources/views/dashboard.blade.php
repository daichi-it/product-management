<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="mt-6 mx-auto max-w-7xl grid grid-cols-2 gap-4">
            ...
            <a href="{{ route('contact.showExportCsv') }}" class="block bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4 text-center text-blue-500 hover:underline">問い合わせCSVエクスポート</a>
